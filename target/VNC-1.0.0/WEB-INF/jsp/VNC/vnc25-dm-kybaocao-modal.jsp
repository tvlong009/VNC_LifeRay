		...
		<div class=" ibox-content">
			<form method="get" id="vnc24-modal-form" class="form-horizontal">
				<div class="form-group">
					...
					<label class="col-sm-9 control-label label-left"><input type="text" class="form-control" name="tenKyBaoCao"></label>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label label-left">Tên</label>
					<div class="col-sm-9">
						<input type="text" class="form-control" name="tenKyBaoCao">
					</div>
				</div>
				<div class="form-group">
