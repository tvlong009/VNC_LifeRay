...
<link href="<c:url value='/style/css/vnc/vnc-13-ql-phanquyentruycapbaocao.css' />" rel="stylesheet">
...
<!-- Input Mask-->
<script src="<c:url value="/style/js/others/inspinia/plugins/jasny/jasny-bootstrap.min.js" />"></script>
...
<!-- MyJS-->
<script src="<c:url value="/style/js/vnc/vnc-13-ql-phanquyentruycapbaocao.js" />"></script>
						...
						<div class="form-group">
							<div class="col-lg-6">
								...
								<div class="form-group padding-bottom-50px">
									...
									<div class="col-sm-8">
										<input name="re_password" data-match="#password" data-match-error="Không giống với Password" type="password" class="form-control">
									</div>
								</div>
								<div class="form-group padding-bottom-50px">
								...
								<div class="form-group padding-bottom-50px"
									...
									<div class="col-sm-8">
										<div class="input-group date">
											<input  name="DOB" type="text" data-mask="99/99/9999"  class="form-control date-picker"><span
							...
							<div class="form-group padding-bottom-0px">
								<div class="ibox-content padding-bottom-0px">
									...
									<div class="table-responsive overflowhidden">
										<table id="vnc13-vaitro-table" class="table table-striped table-bordered">
											<thead class="text-success">
												<tr class="text-primary">

													<th>
														<div class="i-checks">
															<label> <input id="vnc13-vaitro-checkall" type="checkbox">
															</label>
														</div>
													</th>
													<th>Mã</th>
											...
											<tbody>
												<tr>
													<td>
														<div class="i-checks">
															<label> <input  id="vnc13-vaitro-checkbox" type="checkbox" value="">
															</label>
														</div>
													</td>
													<td>1222</td>
											...
											<table id="vnc13-phutrach-table"
												...
												<thead class="text-success">
													<tr class="text-primary">
														...
														<th>
															<div class="i-checks">
																<label> <input id="vnc13-phutrach-checkall" type="checkbox" value="">
																</label>
															</div>
														</th>
														<th>Tên</th>
												...
												<tbody>
													<tr>
														<td>
															<div class="i-checks">
																<label> <input id="vnc13-phutrach-checkbox" type="checkbox" value="">
																</label>
															</div>
														</td>
														<td>Ten Ma</td>
