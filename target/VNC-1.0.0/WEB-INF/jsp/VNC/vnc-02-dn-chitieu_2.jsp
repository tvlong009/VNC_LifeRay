...
<link href="<c:url value='/style/css/others/inspinia/style.css' />"
	rel="stylesheet">
				...
				<div class="row">
					<div class="col-lg-12 text-left padding-bottom-10px">
						<button type="button"
								...
								<i class="fa fa-plus" aria-hidden="true"></i> Thêm Mới Chỉ Tiêu Gốc										</button>
					</div>
					<form>
						<div class="table-responsive col-lg-12">
							<table id="vnc02-treetable" class="table table-striped table-hover table-bordered">
								...
								<!--  <tbody>
								<tr id="treegrid-1" class="treegrid-1">
									<td>I. Sản Phẩm Sản Xuất công nghiệp chủ yếu</td>
									<td>Tỷ đồng</td>
								</tr>
								<tr id="treegrid-2" class="treegrid-2 treegrid-parent-1 context-menu-vnc02">
									<td>1. Bia</td>
									<td>1000 lít</td>
								</tr>

								<tr id="treegrid-3" class="treegrid-3 treegrid-parent-1 context-menu-vnc02">
									<td>2. Cần Câu Cá</td>
									<td>1000 cái</td>
								</tr>

								<tr id="treegrid-4" class="treegrid-4 treegrid-parent-1 context-menu-vnc02">
									<td>3. Máy biến thế</td>
									<td>1000 cái</td>
								</tr>
								<tr id="treegrid-5" class="treegrid-5">
									<td>II. Kim Ngạch Xuất Khẩu</td>
									<td>Tỷ đồng</td>

								</tr>
								<tr id="treegrid-6" class="treegrid-6 treegrid-parent-5 context-menu-vnc02">
