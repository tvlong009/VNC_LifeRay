...
<link href="<c:url value='/style/css/vnc/vnc-26-dm-cotchitieu.css' />" rel="stylesheet">
...
<!-- MyJS-->
<script src="<c:url value="/style/js/vnc/vnc-26-dm-cotchitieu.js" />"></script>

<!-- A PART CONTENT -->
<div class="wrapper wrapper-content row custome-bg paddingtop-0px padding-bottom-20px tooltip-demo">
	<div class="col-lg-10">
		<h2 class="text-success">Danh Mục Cột Chỉ Tiêu</h2>
	</div>
	<br />
	<div class="col-lg-2 text-right">
		<button type="submit" class="btn btn-w-m btn-success" data-toggle="modal" typeaction="them" onclick="showModal(this)">
	...
	<div class="col-lg-12">
		<div class="">
			<div class="ibox-title blue-div">
				<h3>Danh Sách Cột Chỉ Tiêu</h3>
			</div>
			<div class=" ibox-content">
				<div class="form-group ">
					<div class="row">
						<div class="table-responsive col-lg-12">
							<table id="vnc26-table"	class="table table-striped table-bordered">
								<thead>
								...
								<tbody>
									<tr>
										...
										<td class="text-center">
											<button type="button" data-toggle="modal" typeaction="sua" onclick="showModal(this)">
...
<div class="modal inmodal" id="vnc26-modal" tabindex="-1" role="dialog" aria-hidden="true">
	<%@ include file="../VNC/vnc26-dm-cotchitieu-modal.jsp"%>
</div>