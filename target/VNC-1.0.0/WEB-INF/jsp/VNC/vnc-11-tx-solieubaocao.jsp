...
<link href="<c:url value='/style/css/vnc/vnc-11-tx-solieubaocao.css' />" rel="stylesheet">
...
<!-- MyJS-->
<script src="<c:url value="/style/js/vnc/vnc-11-tx-solieubaocao.js" />"></script>
		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				...
				<div class="form-group">
					<div class="ibox-content">
						<div class="row">
							<div id="vnc-11-fileupload" class="col-lg-12">
								<div class="form-group">
									<div class="col-lg-6">
							...
							<div class="col-lg-12">
								<div class="ibox float-e-margins">
									<div class="ibox-content no-padding">
										...
										<div id="vnc11-editor" class="summernote">BÁO CÁO VỀ
