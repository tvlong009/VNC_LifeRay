	...
	<div class="col-lg-12 modal-content white-bg">
			...
			<div class=" ibox-content">
					...
					<div class="row">
						...
						<form method="get" id="vnc02-tm-chitieu" class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input id="tenchitieu" type="text" class="form-control" name="chitieu">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label ">Tên đơn vị tính</label>
								<div class="col-sm-10">
									<input id="donvitinh_chitieu" type="text" class="form-control" name="donvitinh">
								</div>
							</div>
							</form>
						</div>
				...
				<div class="modal-footer">
					...
					<button id="themmoichitieucon" type="submit" class="btn btn-primary">Lưu</button>
				</div>
			</div>
