...
<div class="modal-dialog modal-md">
	<div class="col-lg-12 modal-content white-bg">
		...
		<div class=" ibox-content">
			<form method="get" id="vnc24-modal-form" class="form-horizontal">
				<div class="form-group">
					<label class="col-sm-3 control-label label-left">Mã</label>
					<label class="col-sm-9 control-label label-left"><input type="text" class="form-control" name="tenCotChiTieu"></label>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label label-left">Tên</label>
					<div class="col-sm-9">
						<input type="text" class="form-control" name="tenCotChiTieu">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label label-left">Chú thích</label>
					<div class="col-sm-9">
